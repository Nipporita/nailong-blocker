...
# 中文
_NAI = r"[奶妳乃廼迺仍扔艿𠮨孕奈柰萘錼褦]"
_LONG = r"[龙龍竜龒陇拢珑咙宠笼垄聋隆窿庞龚⻰泷嚨壟寵巄弄曨朧栊櫳瀧爖瓏癃眬砻礱籠聾茏蘢蠪蠬鏧鑨隴靇驡鸗龐龓]"
# 奶的同义多字词
_NAI_SYN = r"(?:奶|乳|乳汁|乳液|酪|奶牛|牛乳|鲜奶|奶子|咪咪|大奶)"
# 龙的别名
...
PATTERNS += [
    ...
    # 倒序: 龙+奶 / long+nai / dragon+milk
    rf"{_LONG}{_SP}{_NAI}",
    rf"{_L}+{_SP}{_O}+{_SP}{_N}+{_SP}{_G}+{_SP}{_N}+{_SP}{_A}+{_SP}{_I}+",
